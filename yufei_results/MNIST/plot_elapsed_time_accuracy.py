...
def main():
    ...
    result_csv_file1 = './MNIST_async_selection_500_20_10stale_10sleep.csv'
    result_dict1 = read_csv_to_dict(result_csv_file1, x_item, y_item)

    result_csv_file2 = './MNIST_oort_500_20_10_10.csv'
    result_dict2 = read_csv_to_dict(result_csv_file2, x_item, y_item)

    result_csv_file3 = './MNIST_fedbuff_500_20_10_10.csv'
    result_dict3 = read_csv_to_dict(result_csv_file3, x_item, y_item)

    result_csv_file4 = './MNIST_fedavg_500_20_10_10.csv'
    result_dict4 = read_csv_to_dict(result_csv_file3, x_item, y_item)
