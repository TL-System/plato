...
def main():
    ...
    result_csv_file1 = './FedAvg_EMNIST_500_20_no_10_concen5.csv'
    result_dict1 = read_csv_to_dict(result_csv_file1, x_item, y_item)

    result_csv_file2 = './oort_EMNIST_lenet5_500_20_10_10_concen5.csv'
    result_dict2 = read_csv_to_dict(result_csv_file2, x_item, y_item)

    result_csv_file3 = './fedbuff_EMNIST_500_20_10_10_concen5.csv'
    result_dict3 = read_csv_to_dict(result_csv_file3, x_item, y_item)

    result_csv_file4 = './async_emnist_concen5_rand2.csv'
    ...
    figure_file_name = './elapsedTime_accuracy_500_20_EMNIST_rand2.pdf'
