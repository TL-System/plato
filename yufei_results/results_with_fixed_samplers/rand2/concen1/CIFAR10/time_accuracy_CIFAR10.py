...
def main():
    ...
    result_csv_file2 = './oort_CIFAR_500_20_10_10_concen1.csv'
    result_dict2 = read_csv_to_dict(result_csv_file2, x_item, y_item)

    result_csv_file3 = './fedbuff_CIFAR_500_20_10_10_concen1.csv'
    result_dict3 = read_csv_to_dict(result_csv_file3, x_item, y_item)

    result_csv_file4 = './async_cifar10_concen1_rand2.csv'
    ...
    figure_file_name = './elapsedTime_accuracy_500_20_CIFAR_rand2.pdf'
