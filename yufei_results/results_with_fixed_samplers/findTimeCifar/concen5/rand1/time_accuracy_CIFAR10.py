...
def main():
    ...
    result_csv_file1 = './fedavg_findtime_concen5_rand1.csv'
    result_dict1 = read_csv_to_dict(result_csv_file1, x_item, y_item)

    result_csv_file2 = './oort_findtime_concen5_rand1.csv'
    result_dict2 = read_csv_to_dict(result_csv_file2, x_item, y_item)

    result_csv_file3 = './fedbuff_cifar_concen5_rand1_real.csv'
    result_dict3 = read_csv_to_dict(result_csv_file3, x_item, y_item)

    result_csv_file4 = './async_findtime_concen5_rand1.csv'
    ...
    figure_file_name = './elapsedTime_accuracy_500_20_CIFAR10_rand1.pdf'
