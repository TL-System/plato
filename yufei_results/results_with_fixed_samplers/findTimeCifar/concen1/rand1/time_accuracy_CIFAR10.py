...
def main():
    ...
    result_csv_file1 = './fedavg_cifar_concen1_rand1.csv'
    result_dict1 = read_csv_to_dict(result_csv_file1, x_item, y_item)

    result_csv_file2 = './oort_cifar_concen1_rand1.csv'
    result_dict2 = read_csv_to_dict(result_csv_file2, x_item, y_item)

    result_csv_file3 = './fedbuff_cifar_concen1_rand1.csv'
    result_dict3 = read_csv_to_dict(result_csv_file3, x_item, y_item)

    result_csv_file4 = './async_cifar_concen1_rand1.csv'
