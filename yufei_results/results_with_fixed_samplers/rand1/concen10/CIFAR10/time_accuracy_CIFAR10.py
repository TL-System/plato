...
def main():
    ...
    result_csv_file1 = './Async_selection_CIFAR_500_20_10_10_concen10.csv'  #
    result_dict1 = read_csv_to_dict(result_csv_file1, x_item, y_item)

    result_csv_file2 = './oort_CIFAR_500_20_10_10_concen10.csv'
    result_dict2 = read_csv_to_dict(result_csv_file2, x_item, y_item)

    result_csv_file3 = './fedbuff_CIFAR_500_20_10_10_concen10.csv'
