...
#) as f:
with open('Async_selection_FEMNIST_simplified_rand1.out') as f:
    for line in f.readlines():
        ...
        if 'Selected clients' in line:
            ...
            outf = open("async_selected_clients.txt", "a")#open("async_selected_clients.txt", "a")
...
with open("async_selected_clients.txt") as f:
    ...
    for line in f.readlines():
        ...
        figure_file_name ='async_selected_client_simplified_distribution.pdf' #'async_selected_clients_distribution.pdf'
