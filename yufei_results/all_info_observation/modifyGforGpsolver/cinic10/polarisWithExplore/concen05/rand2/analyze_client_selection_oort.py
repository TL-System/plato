...
"""
new_outfile = open("client_selection_oort.txt", "w")
new_outfile.close()
with open("Oort_cinic10_concenHalf_rand2.out") as f:
    for line in f.readlines():
        ...
        if "Selected clients" in line:
            ...
            outf = open("client_selection_oort.txt", "a")
...
with open("client_selection_oort.txt") as f:
    ...
    for line in f.readlines():
        ...
        figure_file_name = "distribution_oort.pdf"
