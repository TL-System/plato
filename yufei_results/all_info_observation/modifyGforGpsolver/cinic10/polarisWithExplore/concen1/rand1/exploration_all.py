...
plt.plot(x_value["Polaris"][:36], y_value["Polaris"][:36], label="Polaris")
plt.plot(x_value["Pisces"][:21], y_value["Pisces"][:21], label="Pisces", linestyle="--")
plt.plot(x_value["Oort"][:18], y_value["Oort"][:18], label="Oort", linestyle=":")
plt.plot(
    x_value["FedBuff"][:18], y_value["FedBuff"][:18], label="FedBuff", linestyle="-."
)

figure_file_name = "cinic10_exploration_concen1.pdf"
plt.legend()
