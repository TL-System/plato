...
def plot(
    ...
    ax.plot(
        ...
        linestyle="-.",
        # marker='v',
        label="async_stale",  # async_G_s_femnist_0.3",
    )
    """
    ax.plot(
        x_value3,
...
def main():
    ...
    result_csv_file2 = "async_stale.csv"  # "./async_G_s_point3.csv"
