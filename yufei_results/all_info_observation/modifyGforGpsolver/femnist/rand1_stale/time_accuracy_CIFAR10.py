...
def plot(
    ...
    ax.plot(
        ...
        linestyle=":",
        # marker='s',
        label="async_G_s_staleonly1_init0.01",
    )
    """
    ax.plot(
        x_value6,
        ...
        linestyle=":",
        # marker='s',
        label="async_G_s_staleonly0.1_init0.01",
    )
    ax.plot(
        x_value7,
        y_value7,
        ...
        linestyle=":",
        # marker='s',
        label="async_G_s_staleonly0.1_init0.01_bigA10",
    )
...
def main():
    ...
    result_csv_file6 = "./async_stalepoint1_initpoinpiont1.csv"
    result_dict6 = read_csv_to_dict(result_csv_file6, x_item, y_item)

    result_csv_file7 = "./async_stalepoint1_initpoinpoint1_bigA10.csv"
