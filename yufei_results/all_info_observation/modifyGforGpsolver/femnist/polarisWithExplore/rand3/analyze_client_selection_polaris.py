...
counter_temp = 1
with open("Polaris2_FEMNIST_lenet5_rand3_alphaHalf.out") as f:
    for line in f.readlines():
        ...
        if "Selected clients" in line:
            ...
            counter_inner = 0
            """
            for split_id in clients[0:loc_end].split():
                outf.write(" ")
                outf.write(split_id)
                # print("split id: ", split_id)
                counter_inner += 1
            print("outer idex: ", counter_temp, " Inter counter: ", counter_inner)
            """
