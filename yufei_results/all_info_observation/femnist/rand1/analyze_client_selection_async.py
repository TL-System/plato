...
"""
new_outfile = open("async_pro_selected_clients.txt", "w")
new_outfile.close()
with open("Async_selection_FEMNIST_pro_bigApoint1.out") as f:
    for line in f.readlines():
        ...
        if "Selected clients" in line:
            ...
            outf = open("async_pro_selected_clients.txt", "a")
            outf.write(clients[0:loc_end])
            outf.write(" ")
            outf.close()

with open("async_pro_selected_clients.txt") as f:
    client_set = []
    for line in f.readlines():
        ...
        figure_file_name = "async_pro_selected_clients_distribution_point1.pdf"
