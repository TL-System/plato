...
with open("pisces_selected_clients.txt") as f:
    ...
    for line in f.readlines():
        ...
        figure_file_name = "pisces_selected_clients_distribution.pdf"  #'async_selected_clients_distribution.pdf'
