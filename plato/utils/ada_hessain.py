"""
A customized optimizer for fedunlearning

Reference:

Z. Yao, A. Gholami, S. Shen, M. Mustafa, K. Keutzer, and M. Mahoney, “Adahessian: An adaptive second order optimizer for machine learning,” in Proc. of AAAI, 2021.
...
class AdaHessian(torch.optim.Optimizer):
    """A customized optimizer for fed_unlearning's local server.
    """
    def __init__(self, params, lr, betas, eps, weight_decay, hessian_power=1.0, update_each=1, n_samples=1, average_conv_kernel=False):
        if not 0.0 <= lr:
