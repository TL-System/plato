...
```shell
uv run examples/model_pruning/fedscr/fedscr.py \
  -c examples/model_pruning/fedscr/fedscr_MNIST_lenet5.yml
```
...
```shell
uv run examples/model_pruning/sub_fedavg/subfedavg.py \
  -c examples/model_pruning/sub_fedavg/subfedavg_MNIST_lenet5.yml
```

**For three-layer federated learning:**

```shell
uv run examples/model_pruning/sub_fedavg/subcs.py \
  -c examples/model_pruning/sub_fedavg/subcs_MNIST_lenet5.yml
```
