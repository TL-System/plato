...
```shell
uv run examples/three_layer_fl/tempo/tempo.py \
  -c examples/three_layer_fl/tempo/tempo_MNIST_lenet5.yml
```
...
```shell
uv run examples/three_layer_fl/fedsaw/fedsaw.py \
  -c examples/three_layer_fl/fedsaw/fedsaw_MNIST_lenet5.yml
```
