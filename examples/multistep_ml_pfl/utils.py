...
def verify_difference_between_clients(clients_id,
    ...
    for client_id in clients_id:
        ...
        selected_clients = test_sampler.obtain_selected_consistent_clients()
        if is_presented:
            print("Selected clients: ",
                  test_sampler.obtain_selected_consistent_clients())
    ...
    return selected_clients, clients_classes_info, clients_classes_sample_info