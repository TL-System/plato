...
class ModelReinitializationCallback(TrainerCallback):
    ...
    This is needed for FedRolexFL to create the model with specific parameters.
    """
    ...
    def on_trainer_initialized(self, trainer, **kwargs):
        ...
        if self.model_class is not None:
            ...
            logging.info("Model reinitialized with config parameters for FedRolexFL")
...
class ServerTrainer(Trainer):
    ...
    def __init__(self, model=None, callbacks=None):
        """
        Initialize the FedRolexFL server trainer.
