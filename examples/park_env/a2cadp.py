...
import a2cadp_learning_server
import a2c_learning_trainer

# to run
# python examples/park_env/a2cadp.py -c examples/park_env/a2cadp_seed_15.yml
...
def main():
    ...
    client = a2c_learning_client.RLClient(
        model=model, trainer=trainer, algorithm=algorithm
    )
    server = a2cadp_learning_server.A2CServer(
