...
def get_version():
    ...
    version_file = os.path.join(current_dir, "pflbases", "__init__.py")
...
setuptools.setup(
    ...
    classifiers=[
        ...
        "Topic :: Software Development :: Libraries :: Python layers",
        "Topic :: Education",
        "Topic :: Scientific/Engineering",
        "Topic :: Scientific/Engineering :: Artificial Intelligence",
    ],
    keywords="fit, plot, experiments, visualization",
)
