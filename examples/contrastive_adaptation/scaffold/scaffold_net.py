"""
The implementation of the model structure used in the Scaffold method,
...
vgg model, the Scaffold's model structure is
...
negative impact on the performance of the Scaffold.
