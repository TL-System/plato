...
class Network(nn.Module):
  ...
  def __init__(self, C=3, num_classes=10, layers=8, criterion=nn.CrossEntropyLoss(), steps=4, multiplier=4, stem_multiplier=3):
    ...
    self.stem = nn.Sequential(
      nn.Conv2d(self._C, C_curr, 3, padding=1, bias=False),
